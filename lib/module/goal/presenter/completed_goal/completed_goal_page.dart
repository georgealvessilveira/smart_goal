...
import 'package:smart_goals/module/goal/presenter/completed_goal/completed_goal_store.dart';
...
class _CompletedGoalPageState extends State<CompletedGoalPage> {
  final CompletedGoalStore store = Modular.get<CompletedGoalStore>();
  ...
  Widget build(BuildContext context) {
    ...
    return ScopedBuilder<CompletedGoalStore, CompletedGoalState>(
      ...
      onState: (context, state) {
        ...
        state.description = widget.goal.title;
